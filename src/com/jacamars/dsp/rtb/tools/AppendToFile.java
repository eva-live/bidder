...
public class AppendToFile {
	...
	public static volatile Map<String, BufferedWriter> files = new ConcurrentHashMap<String, BufferedWriter>();

	public static int item(String fileName, StringBuilder sb) throws Exception {
