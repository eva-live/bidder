...
import com.jacamars.dsp.rtb.exchanges.adx.RealtimeBidding.BidResponse.Ad;
import com.jacamars.dsp.rtb.exchanges.adx.RealtimeBidding.BidResponse.Ad.AdSlot;
...
public class AdxBidResponse extends BidResponse {
	...
	@JsonIgnore
	private transient com.jacamars.dsp.rtb.exchanges.adx.RealtimeBidding.BidResponse.Ad.AdSlot.Builder  slotBuilder;
	
	@JsonIgnore
	private transient com.jacamars.dsp.rtb.exchanges.adx.RealtimeBidding.BidResponse.Ad.Builder adBuilder;
	
	@JsonIgnore
	private transient List<Ad> adList = new ArrayList<Ad>();
	...
	public void adSetImpressionTrackingUrl(String str) {
		...
		try {
			MacroProcessing.replace(creat.macros, br, creat, imp, adid, sb, null, dealId);
