...
public class GoogleBidRequest extends BidRequest {
	...
	public void handleConfigExtensions(Map extension) {
		...
		GoogleWinObject.encryptionKeyBytes = e_key = javax.xml.bind.DatatypeConverter.parseBase64Binary(ekey);
		GoogleWinObject.integrityKeyBytes = i_key = javax.xml.bind.DatatypeConverter.parseBase64Binary(ikey);
	}
