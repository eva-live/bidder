	...
	//	Document doc = db.parse(is);
	  ...
	  @Test
		public void testPiggyBackedNoNurl() throws Exception {  
			...
			price = null;
			com.jacamars.dsp.rtb.jmq.RTopic wchannel = new com.jacamars.dsp.rtb.jmq.RTopic("tcp://*:5572&wins");
			wchannel.subscribe("wins");
			wchannel.addListener(new com.jacamars.dsp.rtb.jmq.MessageListener<WinObject>() {
				@Override
