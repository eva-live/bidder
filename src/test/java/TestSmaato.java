...
import com.jacamars.dsp.rtb.pojo.SmaatoTemplate;
...
public class TestSmaato {
	...
	public void testBannerRespondWithBid() throws Exception {
		...
		try {
			...
			System.out.println(URLDecoder.decode(adm, java.nio.charset.StandardCharsets.UTF_8.toString()));
